...
class Solution {
     static int cnt=0;
       public static void inorder(Node root,ArrayList<Node> ds){
        if(root==null) return;
...
ds.add(root);
    ...
    public static void inorder2(Node root,ArrayList<Node> ds){
        if(root==null) return;
     inorder2(root.left,ds);
           //  System.out.println(cnt);
     if(cnt!=ds.size()-1){
         root.next=ds.get(cnt+1);
     }
     cnt++;
     inorder2(root.right,ds);
    }
