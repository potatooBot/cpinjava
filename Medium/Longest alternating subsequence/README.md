<h2><a href="https://practice.geeksforgeeks.org/problems/longest-alternating-subsequence5951/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Longest alternating subsequence</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">A sequence {x1, x2, .. xn} is alternating sequence if its elements satisfy one of the following relations :<br>
